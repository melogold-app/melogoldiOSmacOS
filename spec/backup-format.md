...
- Настоящая копия ViTune v30 есть у пользователя. Она приватная, в репозиторий не класть. В пустой библиотеке ожидается: 1314 треков, 16 046 прослушиваний, 21 в Избранном, 300 текстов, 3 сохранённых, 16 локальных пропущено.
